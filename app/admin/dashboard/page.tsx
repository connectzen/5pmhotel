        ...
        <Link href="/admin/bookings">
          <Card className="p-6 hover:shadow-xl transition-all duration-300 cursor-pointer border-l-4 border-l-primary bg-gradient-to-br from-card to-card/95 group">
            <div className="flex items-center justify-between">
              <div className="flex-1">
                <h3 className="font-semibold text-foreground mb-2 text-lg group-hover:text-primary transition-colors">View All Bookings</h3>
                <p className="text-sm text-muted-foreground mb-4">Manage all room and venue bookings</p>
                <div className="flex items-baseline gap-2">
                  <p className="text-3xl font-bold text-foreground group-hover:text-accent transition-colors">{(kpis as any).totalBookings || bookings.length}</p>
